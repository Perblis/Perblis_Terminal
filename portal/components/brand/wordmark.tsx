...
/**
 * Brand lockups per 01 §1. The mark (D): a map pin with a crane-hook cutout
 * and a hex container-casting tail — map-first identity, crane DNA. Source of
 * truth: portal/public/terminal-mark.svg; glyph geometry:
 * packages/tokens/glyphs/brand/t-crane.svg.
 */
