...
export function LostContainerIllustration() {
  return (
    <svg viewBox="0 0 160 120" width="160" height="120" aria-hidden fill="none">
      ...
      <rect x="96" y="24" width="40" height="20" stroke="#E0ED34" strokeWidth="2" transform="rotate(8 116 34)" />
      <path d="M88 68 l8 -12" stroke="#ADAEB0" strokeWidth="1" strokeDasharray="3 3" />
    </svg>
  );
}
...
export function BreakdownIllustration() {
  return (
    <svg viewBox="0 0 160 120" width="160" height="120" aria-hidden fill="none">
      ...
      <path d="M54 44 l8 14 h-16 z" stroke="#E0ED34" strokeWidth="2" />
    </svg>
  );
}
...
export function GateIllustration() {
  return (
    <svg viewBox="0 0 160 120" width="160" height="120" aria-hidden fill="none">
      ...
      <path d="M48 60 h84" stroke="#E0ED34" strokeWidth="3" />
      <path d="M60 60v4M76 60v4M92 60v4M108 60v4M124 60v4" stroke="#E0ED34" strokeWidth="1.5" />
    </svg>
  );
}
