...
from listings.models import Listing, ListingStatus, ResourceType, VerificationTier
...
LISTINGS = [
    # ── LAGOS — Equipment ──────────────────────────────────────────────────
    {
        ...
        'price_daily': 85000, 'price_weekly': 500000, 'price_monthly': 1800000,
        ...
        'location_city': 'Lagos',
        'operator_available': True, 'verification_tier': VerificationTier.INSPECTED,
    },
    {
        'owner_email': 'owner1@test.com',
        'resource_type': ResourceType.EQUIPMENT,
        ...
        'category': 'Excavator',
        'price_daily': 55000, 'price_weekly': 320000, 'price_monthly': 1100000,
        ...
        'location_city': 'Lagos',
        'operator_available': True, 'verification_tier': VerificationTier.VERIFIED,
    },
    {
        'owner_email': 'dual@test.com',
        'resource_type': ResourceType.EQUIPMENT,
        ...
        'price_daily': 350000, 'price_weekly': 2000000,
    ...
    },
    {
        ...
        'price_daily': 110000, 'price_weekly': 650000, 'price_monthly': 2300000,
    ...
    },
    {
        ...
        'description': '21-tonne Komatsu excavator with rock bucket. Ideal for quarry, road construction, and drainage works.',
        'category': 'Excavator',
        'price_daily': 58000, 'price_weekly': 330000, 'price_monthly': 1150000,
        ...
        'location_city': 'Lagos',
        'operator_available': False, 'verification_tier': VerificationTier.VERIFIED,
    },
    {
        'owner_email': 'owner2@test.com',
        'resource_type': ResourceType.EQUIPMENT,
        ...
        'price_daily': 32000, 'price_weekly': 185000, 'price_monthly': 650000,
        ...
        'location_city': 'Lagos',
        'delivery_available': True, 'verification_tier': VerificationTier.BASIC,
    },
    {
        'owner_email': 'dual@test.com',
        'resource_type': ResourceType.EQUIPMENT,
        ...
        'price_daily': 65000, 'price_weekly': 380000,
    ...
    },
    {
        ...
        'price_daily': 120000, 'price_weekly': 700000,
        'specs': {'boom_reach_m': 42, 'output_m3_hr': 90, 'crew_included': True, 'year': 2019},
        'location': Point(3.3792, 6.5244, srid=4326),
        'location_address': 'Marina Road, Lagos Island',
        'location_city': 'Lagos',
        'operator_available': True, 'delivery_available': True, 'verification_tier': VerificationTier.VERIFIED,
    },
    # ── LAGOS — Vehicles ───────────────────────────────────────────────────
    {
        'owner_email': 'owner2@test.com',
        ...
        'price_daily': 45000, 'price_weekly': 260000, 'price_monthly': 900000,
        ...
        'location_city': 'Lagos',
        'delivery_available': True, 'verification_tier': VerificationTier.VERIFIED,
    },
    {
        'owner_email': 'owner2@test.com',
        'resource_type': ResourceType.VEHICLE,
        ...
        'price_daily': 28000, 'price_weekly': 160000,
    ...
    },
    {
        ...
        'price_daily': 60000, 'price_weekly': 350000,
    ...
    },
    {
        ...
        'price_daily': 38000, 'price_weekly': 220000,
    ...
    },
    {
        ...
        'price_daily': 42000, 'price_weekly': 240000,
        'specs': {'lift_capacity_tonnes': 10, 'reach_m': 12, 'year': 2019},
        'location': Point(3.3669, 6.5833, srid=4326),
        'location_address': 'Oregun Industrial Estate, Ikeja, Lagos',
        'location_city': 'Lagos',
        'delivery_available': True, 'operator_available': True, 'verification_tier': VerificationTier.VERIFIED,
    },
    # ── LAGOS — Warehouses ────────────────────────────────────────────────
    {
        'owner_email': 'owner1@test.com',
    ...
    },
    {
        ...
        'price_monthly': 2200000, 'price_weekly': 600000,
    ...
    # ── LAGOS — Facilities ────────────────────────────────────────────────
    {
        ...
        'price_monthly': 1500000, 'price_weekly': 420000,
    ...
    },
    {
        ...
        'description': 'Heavy equipment maintenance workshop with 10-tonne overhead crane, lubrication bay, and 4 inspection pits.',
        'category': 'Maintenance Workshop',
        'price_monthly': 2500000, 'price_weekly': 700000,
    ...
    # ── PORT HARCOURT ──────────────────────────────────────────────────────
    {
        ...
        'category': 'Mobile Crane',
        'price_daily': 150000, 'price_weekly': 900000, 'price_monthly': 3200000,
    ...
    },
    {
        ...
        'description': '500-tonne lattice boom crane for major heavy lifts in the Niger Delta. Operator and rigger team available.',
        'category': 'Mobile Crane',
        'price_daily': 650000, 'price_weekly': 3800000,
    ...
    },
    {
        ...
        'price_daily': 90000, 'price_weekly': 530000, 'price_monthly': 1900000,
    ...
    },
    {
        ...
        'description': '20-tonne HIAB crane truck for heavy goods delivery and field installation. Available for PH and Rivers State.',
        'category': 'Crane Truck',
        'price_daily': 55000, 'price_weekly': 320000,
    ...
    },
    {
        ...
        'description': 'Customs-bonded warehouse in Onne Oil & Gas Free Zone. Suitable for oilfield equipment, chemicals, and general cargo.',
        'category': 'Bonded Warehouse',
    ...
    },
    {
        ...
        'description': '3-acre hardstanding yard for oilfield equipment staging and storage. Perimeter wall, CCTV, 24/7 security.',
        'category': 'Equipment Yard',
    ...
    # ── ABUJA ──────────────────────────────────────────────────────────────
    {
        ...
        'category': 'All-Terrain Crane',
        'price_daily': 180000, 'price_weekly': 1050000, 'price_monthly': 3800000,
    ...
    },
    {
        ...
        'category': 'Excavator',
        'price_daily': 62000, 'price_weekly': 360000, 'price_monthly': 1250000,
    ...
    },
    {
        ...
        'price_daily': 70000, 'price_weekly': 410000, 'price_monthly': 1450000,
        ...
        'location_city': 'Abuja',
        'operator_available': True, 'verification_tier': VerificationTier.BASIC,
    },
    {
        'owner_email': 'owner4@test.com',
        'resource_type': ResourceType.VEHICLE,
        'title': 'Low-Loader Truck — 50T (Abuja)',
        'description': '50-tonne heavy equipment transporter based in Abuja. Available for FCT and intercity equipment mobilisation.',
        'category': 'Low-Loader Truck',
        'price_daily': 65000, 'price_weekly': 380000,
    ...
    },
    {
        ...
        'description': 'Modern distribution warehouse near Jabi Lake. Suitable for FMCG, construction materials, and general cargo.',
    ...
    # ── KANO ───────────────────────────────────────────────────────────────
    {
        ...
        'category': 'Crawler Crane',
        'price_daily': 420000, 'price_weekly': 2400000,
    ...
    },
    {
        ...
        'category': 'Dump Truck',
        'price_daily': 78000, 'price_weekly': 455000, 'price_monthly': 1600000,
    ...
    },
    {
        ...
        'description': 'Large-capacity grain storage warehouse near Dawanau Market. Suitable for cereals, legumes, and agro-commodities.',
    ...
    # ── IBADAN ─────────────────────────────────────────────────────────────
    {
        ...
        'price_monthly': 1800000, 'price_weekly': 520000,
    ...
    },
    {
        ...
        'category': 'Compactor',
        'price_daily': 28000, 'price_weekly': 162000, 'price_monthly': 570000,
    ...
    # ── WARRI ──────────────────────────────────────────────────────────────
    {
        ...
        'price_daily': 200000, 'price_weekly': 1150000,
    ...
    },
    {
        ...
        'price_daily': 72000, 'price_weekly': 420000,
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--reset',
            action='store_true',
            help='Delete all existing seed listings before creating (identified by seed owner emails)',
        )
    ...
    def handle(self, *args, **options):
        ...
        if options['reset']:
            seed_emails = {u['email'] for u in OWNERS}
            deleted, _ = Listing.objects.filter(owner__email__in=seed_emails).delete()
        ...
        for u in OWNERS:
            ...
            u['password'] = password  # restore so dict stays reusable
            user_map[user.email] = user

        # ── Owner profiles ─────────────────────────────────────────────────
        for email, profile_data in OWNER_PROFILES.items():
            ...
            if created or not profile.business_name:
                ...
                profile.save()
                self.stdout.write(f'  Created profile: {profile_data["business_name"]}')
        ...
        for data in LISTINGS:
            ...
            data['owner_email'] = owner_email  # restore

        self.stdout.write(self.style.SUCCESS(
            f'\nSeed complete — {created_count} new listings created ({len(LISTINGS)} total defined)'
        ))
        self.stdout.write('\nTest credentials (all passwords: test1234!):')
        self.stdout.write('  owner1@test.com  — Lagos cranes & excavators')
        self.stdout.write('  owner2@test.com  — Lagos vehicles & warehouses')
        self.stdout.write('  owner3@test.com  — PH / Warri / Ibadan')
        self.stdout.write('  owner4@test.com  — Abuja / Kano')
        self.stdout.write('  dual@test.com    — Owner + Renter')
        self.stdout.write('  renter1@test.com — Renter')
        self.stdout.write('  renter2@test.com — Renter')
