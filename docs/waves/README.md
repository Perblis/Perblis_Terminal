...
| 8 | [wave-8.md](wave-8.md) | Hirer app complete (FSD §10.1, screens `ux/02` S1–S17) | 🟡 **Founder GO 2026-07-06** — vision session captured in [wave-8-vision.md](wave-8-vision.md); building slices 8A → 8F |
