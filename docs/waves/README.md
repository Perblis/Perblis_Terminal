...
| 3 | [wave-3.md](wave-3.md) | Search: map endpoint (yard aggregation), list, filters | 🟡 Build complete (Slices 1–4: map #23, list #24, geocode + perf #25) — pending founder demo + sign-off |
