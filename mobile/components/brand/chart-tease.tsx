  ...
  return (
    <View className="absolute inset-0 bg-ink-900" accessible={false}>
      <Svg width="100%" height="100%" viewBox="0 0 375 812" preserveAspectRatio="xMidYMid slice">
        {/* water */}
        <Path d="M0 500 Q120 460 200 520 T375 500 V812 H0 Z" fill="#141617" opacity={0.9} />
        {/* depth lines */}
        <G stroke="#26272B" strokeWidth={1} opacity={0.5} fill="none">
        ...
        <G stroke="#1A1C1E" strokeWidth={1.5} opacity={0.8}>
        ...
        <G>
          <Path
            ...
            strokeWidth={2.5}
          />
          <Circle cx={196} cy={252} r={9} fill="#E0ED34" />
        </G>
        {/* asset teardrop pins, class hues */}
        <G>
          <Path d="M90 380 a14 14 0 1 1 28 0 c0 10 -14 24 -14 24 s-14 -14 -14 -24 Z" fill="#E0ED34" stroke="#19191C" strokeWidth={1.5} />
          <Path d="M255 330 a14 14 0 1 1 28 0 c0 10 -14 24 -14 24 s-14 -14 -14 -24 Z" fill="#4D9AFF" stroke="#19191C" strokeWidth={1.5} />
          <Path d="M300 430 a14 14 0 1 1 28 0 c0 10 -14 24 -14 24 s-14 -14 -14 -24 Z" fill="#2ECC71" stroke="#19191C" strokeWidth={1.5} />
        </G>
        {/* compass rose, chart identity */}
        <G opacity={0.6}>
          <Circle cx={320} cy={700} r={26} stroke="#8C8D90" strokeWidth={1} fill="none" />
          <Path d="M320 678 L326 700 L320 722 L314 700 Z" fill="#E0ED34" />
        </G>
      </Svg>
    </View>
  );
